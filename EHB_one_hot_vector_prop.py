...
# K=1 32.31, 33.42, 35.04, 35.79, 33.95, 39.68, 36.27, 32.06, 32.45, 33.76 (補正なし)
# K=1 33.08, 32.89, 34.50, 33.68, 34.74, 38.87, 36.53, 31.04, 32.18, 32.74 (補正あり)
# K=2 58.54, 49.48, 47.45, 48.83, 55.24, 50.53, 47.78, 47.70, 54.07, 55.01 (補正なし)
# K=2 79.40, 76.55, 74.53, 74.15, 80.37, 77.63, 73.63, 78.32, 77.17, 79.69 (補正あり)
# K=3 65.09, 63.54, 70.43, 67.02, 65.13, 64.29, 59.21, 63.97, 70.63, 56.76 (補正なし)
# K=3 90.03, 91.39, 90.86, 91.62, 91.28, 92.33, 90.26, 90.34, 90.74, 92.57 (補正あり)
import numpy as np
import json
