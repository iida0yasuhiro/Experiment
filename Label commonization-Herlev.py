# AMLDAS向けLabel commonization - Herlev
...
for _ in range(num_trials):
 ...
 # 行番号ごとの閾値設定
 thresholds = np.full(Z_5.shape[0], 0.3)  # 初期値を0.3に設定
 thresholds[:675] = 0.3  # 異常カテゴリ４分類:675個。1行目から675行目までを0.2に変更　★★★
 thresholds[675:917] = 0.7  # 正常カテゴリ1分類：242個。676行目から917行目までを0.4に変更　★★★
