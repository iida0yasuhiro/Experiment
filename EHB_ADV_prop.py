...
# 実験２　本実験　11人の混同行列による補正あり・なしで比較。どちらも確率分布のまま。10回再実験。
# K=1 35.41, 33.80, 33.54, 37.26, 35.80, 35.04, 33.07, 33.23, 34.22, 32.65 (補正なし)
# K=1 34.77, 32.49, 34.27, 35.22, 32.81, 33.60, 31.96, 33.70, 31.41, 31.87 (補正あり)
# K=2 50.27, 42.25, 53.39, 45.57, 45.81, 50.55, 46.47, 43.17, 41.40, 43.51 (補正なし)
# K=2 76.90, 71.25, 75.75, 72.94, 74.68, 72.05, 77.22, 73.08, 76.83, 71.67 (補正あり)
# K=3 79.38, 69.92, 68.88, 70.89, 74.88, 67.19, 66.56, 70.08, 71.25, 66.19 (補正なし)
# K=3 88.63, 93.01, 89.05, 91.46, 91.52, 89.64, 89.56, 88.91. 86.10, 89.03 (補正あり)
import numpy as np
import json
